...
public class Database {
    ...
    private void fillFreeplayGames() {
        ...
        GameSettingsPair gspTunnel = new GameSettingsPair(GameTunnel.class,
                settingsTunnel);
        ...
        GameSettingsPair gspPong = new GameSettingsPair(GamePong.class, settingsPong);
        ...
        // GameSettingsPair(GameMaze.class,
        // settings);
        ...
        GameSettingsPair gspLights = new GameSettingsPair(GameLights.class,
                settingsLights);
        ...
        GameSettingsPair gspUniversal = new GameSettingsPair(GameUniversal.class,
                settingsUniversal);
        ...
        GameSettingsPair gspUniversal3D = new GameSettingsPair(GameUniversal3D.class,
                settingsUniversal3D);
        ...
        GameSettingsPair gspSensor = new
                GameSettingsPair(GameSensor.class,
                        settingsSensor);
    ...
    private void fillTrainings() {
        ...
        training0.add(new GameSettingsPair(GameUniversal.class, upperLeft));
        // upperRight
        ...
        training0.add(new GameSettingsPair(GameUniversal.class, upperRight));
        // middle
        ...
        training0.add(new GameSettingsPair(GameUniversal.class, middle));
        // lowerLeft
        ...
        training0.add(new GameSettingsPair(GameUniversal.class, lowerLeft));
        // lowerRight
        ...
        training0.add(new GameSettingsPair(GameUniversal.class, lowerRight));
        // middle
        training0.add(new GameSettingsPair(GameUniversal.class,
                (Bundle) middle.clone()));
        mTrainings.add(training0);

        // Test training
        Training training1 = new Training("Test Training");
        training1.add(new GameSettingsPair(GamePong.class, new Bundle()));
        training1.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training1.add(new GameSettingsPair(GameLights.class, new Bundle()));
        training1.add(new GameSettingsPair(GameMaze.class, new Bundle()));
        mTrainings.add(training1);

        Training training2 = new Training("Test Training 2");
        training2.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training2.add(new GameSettingsPair(GamePong.class, new Bundle()));
        training2.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training2.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training2.add(new GameSettingsPair(GameLights.class, new Bundle()));
        mTrainings.add(training2);

        Training training3 = new Training("Noch ein Training");
        training3.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training3.add(new GameSettingsPair(GamePong.class, new Bundle()));
        training3.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training3.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
        training3.add(new GameSettingsPair(GameLights.class, new Bundle()));
        mTrainings.add(training3);

        for (int i = 0; i < 10; i++) {
            Training training5 = new Training("Training" + i);
            training5.add(new GameSettingsPair(GameUniversal.class, new Bundle()));
